...
export default function DeliveryModal(props: any) {
  return (
    <div className="fixed z-50 w-full h-[100vh] top-0 left-0 ">
      ...
      ></div>
      <div className="max-sm:w-full max-sm:top-[40%] absolute z-[3] translate-x-[-50%] translate-y-[-50%] top-1/2 left-1/2 bg-gray-100 w-1/2 p-8 animate-[modalOpacity_0.5s_linear]  overflow-hidden">
